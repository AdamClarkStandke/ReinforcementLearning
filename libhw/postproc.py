...
class PostPitchRoll:
    ...
    def __init__(self, buffer, pad_yaw):
        ...
        ######TO DO  #######################################
        # THIS HAS TO BE REPLACED WITH MY SENSOR base lib functions
        # assert isinstance(buffer.sensors[0],BerryIMU_Sensor.base)
    ...
    def __iter__(self):
        for b_list in self.buffer:
            for b in b_list:
            	...
            	##########TO DO #########################################################
                # THIS HAS TO BE REPLACED WITH MY SENSOR base lib functions might add decoder
                # data = BerryIMU_Sensor.base.decode(b)
